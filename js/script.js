...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const definitions = {
        ...
        igcse: {
            ...
            explanation:
                "An internationally recognised secondary-school qualification commonly studied before AS and A Levels."
        },
        ...
        "as-level": {
            ...
            explanation:
                "The first stage of the A Level qualification, normally completed before progressing to the full A Level."
        },
        ...
        "flight-training": {
            ...
            explanation:
                "Structured theoretical and practical instruction through which a student develops flying skills and works toward pilot licences and ratings."
        },
        ...
        cpl: {
            ...
            explanation:
                "A professional pilot licence that allows its holder to be paid for flying, subject to the licence privileges, ratings and applicable aviation regulations."
        },
        ...
        "type-rating": {
            ...
            explanation:
                "Additional training and certification required to operate a specific complex aircraft type, such as an Airbus A320 or Boeing 737."
        },
        ...
        "first-officer": {
            ...
            explanation:
                "A qualified airline pilot who shares responsibility for operating the aircraft and normally serves as second-in-command alongside the captain."
        }
    ...
    const decoderEyebrow =
        document.createElement("span");


    decoderEyebrow.className =
        "msa-term-card__eyebrow";


    decoderEyebrow.textContent =
        "QUICK DEFINITION";
    ...
    decoderTitle.className =
        "msa-term-card__title";


    const decoderExpanded =
        document.createElement("span");


    decoderExpanded.className =
        "msa-term-card__expanded";
    ...
    decoderExplanation.className =
        "msa-term-card__explanation";
    ...
    decoderHint.className =
        "msa-term-card__hint";


    decoderHint.textContent =
        "Press Escape or select anywhere else to close.";
    ...
    terms.forEach(term => {
        ...
        const termKey =
            term.dataset.msaTerm;


        if(!definitions[termKey]){

            /*
            Hide the decoder styling if a term was
            marked but has no matching definition.
            */
        ...
        term.setAttribute(
            "aria-label",
            `${term.textContent.trim()}: show definition`
        );
    ...
    function positionDecoderCard(term){
        ...
        /*
        Make the card visible before measuring it.
        Visibility keeps the measurement hidden
        from the user until positioning is finished.
        */

        decoderCard.style.visibility =
            "hidden";
        ...
        const cardRect =
            decoderCard.getBoundingClientRect();
        ...
        decoderCard.style.left =
            `${Math.round(left)}px`;


        decoderCard.style.top =
            `${Math.round(top)}px`;
    ...
    function openDefinition(term){
        ...
        if(
            ...
            activeTerm.setAttribute(
                "aria-expanded",
                "false"
            );


            activeTerm.classList.remove(
                "is-active"
            );
        ...
        decoderTitle.textContent =
            definition.title;


        decoderExpanded.textContent =
            definition.expanded;


        decoderExplanation.textContent =
    ...
    document.addEventListener(
        ...
        event => {
            ...
            if(selectedTerm){
                ...
                /*
                Stop the timeline card before its own
                click behaviour can open the milestone.
                */
    ...
    /* ======================================================
       CLOSE WHEN THE PAGE POSITION CHANGES
    ====================================================== */
...
/* ==========================================================
   SHAREABLE SECTION INTELLIGENCE
========================================================== */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if(shareableSections.length === 0){
        return;
    }


    /* ======================================================
       COPY TEXT WITH A SAFE FALLBACK
    ====================================================== */
    ...
    async function copyText(text){
        ...
        /*
        Fallback for local HTML files and browsers
    ...
    shareableSections.forEach(section => {
        ...
        /*
        Prevent duplicate controls if the script
        is ever initialised more than once.
        */

        if(
            section.querySelector(
                `:scope .msa-share-control[data-msa-share-target="${sectionId}"]`
            )
        ){
            return;
        }
        ...
        shareButton.dataset.msaShareTarget =
            sectionId;


        shareButton.setAttribute(
            "aria-label",
            `Copy a direct link to ${heading.textContent.trim()}`
        );
        ...
        shareLabel.className =
            "msa-share-control__label";
        ...
        /*
        Position the control directly after
        the section's first heading.
        */
        ...
        shareButton.addEventListener(
            ...
            async event => {
                ...
                /*
                Prevent timeline milestone cards from
                opening when the share control is clicked.
                */
                ...
                /*
                Remove temporary URL parameters while
                keeping the page and section hash.
                */
                ...
                try {
                    ...
                    shareButton.setAttribute(
                        "aria-label",
                        `Direct link to ${heading.textContent.trim()} copied`
                    );
        ...
        /*
        Stop keyboard actions from reaching
    ...
    /* ======================================================
       REVEAL A SECTION OPENED FROM A SHARED LINK
    ====================================================== */
    ...
    /*
    Wait until the page layout and fixed navigation
    have finished settling.
    */

    window.setTimeout(() => {

        sharedSection.scrollIntoView({
            behavior:
                window.matchMedia(
                    "(prefers-reduced-motion: reduce)"
                ).matches
        ...
        window.setTimeout(() => {
            ...
            sharedSection.classList.remove(
                "msa-shared-arrival"
            );
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const evidenceStates = {
        ...
        verified: {
            ...
            description:
                "This credential includes an external verification source.",
        ...
        documented: {
            ...
            description:
                "This experience is recorded as part of the portfolio journey.",
        ...
        ongoing: {
            ...
            description:
                "This activity or learning process is currently in progress.",
        ...
        planned: {
            ...
            description:
                "This represents a future objective rather than a completed achievement.",
    ...
    function readReviewDate(dateValue){
    ...
    function calculateAgeInDays(reviewDate){
    ...
    /* ======================================================
       BUILD EACH EVIDENCE FOOTER
    ====================================================== */

    evidenceItems.forEach(item => {

        /*
        Prevent duplicate metadata if the script
        is ever initialised more than once.
        */

        if(
            item.querySelector(
                ":scope > .msa-evidence-meta"
            )
        ){
            return;
        }
        ...
        const statusKey =
            item.dataset.msaEvidenceStatus;


        const evidenceState =
            evidenceStates[statusKey];


        const reviewDate =
            readReviewDate(
                item.dataset.msaReviewed
            );
        ...
        evidenceFooter.className =
            "msa-evidence-meta";


        evidenceFooter.setAttribute(
            "aria-label",
            `${evidenceState.label}. Information reviewed ${formatReviewDate(reviewDate)}.`
        );
        ...
        statusSymbol.className =
            "msa-evidence-status__symbol";


        statusSymbol.setAttribute(
            "aria-hidden",
            "true"
        );
        ...
        reviewInformation.className =
            "msa-evidence-reviewed";
        ...
        reviewInformation.append(
            reviewLabel,
            reviewTime
        );


        evidenceFooter.append(
            statusLabel,
            reviewInformation
        );
...
/* ==========================================================
   RETURN-VISITOR UPDATE BRIEFING
========================================================== */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const currentRelease = {
        ...
        changes: [
            "Added accessible explanations for important aviation and academic terminology.",
            "Added direct, shareable links to important portfolio sections.",
            "Added verification states and review dates to credentials and experiences."
        ]
    ...
    const releaseStorageKey =
        "msa-portfolio-release-seen";


    /*
    Preview mode allows you to test the briefing
    without changing the release version.

    Example:
    index.html?preview-release=1
    */

    const previewMode =
        new URLSearchParams(
            window.location.search
        ).get("preview-release") === "1";


    let previouslySeenRelease =
        null;


    try {

        previouslySeenRelease =
            localStorage.getItem(
                releaseStorageKey
            );
        ...
        /*
        A completely new visitor should not receive
        a "since your last visit" message.
        */
        ...
        /*
        Do not repeat a release that the visitor
        ...
        */
        ...
        /*
        Do not display a repeating briefing when
    ...
    function rememberCurrentRelease(){
        ...
        try {
            ...
            /*
            Dismissal still works if storage becomes
            unavailable after the briefing opens.
            */
    ...
    function mountReleaseBriefing(){
        ...
        /*
        Never overlap the cinematic introduction.
        */
        ...
        briefing.className =
            "msa-release-briefing";


        briefing.setAttribute(
            "aria-label",
        ...
        releaseIndicator.className =
            "msa-release-briefing__indicator";


        releaseIndicator.setAttribute(
            "aria-hidden",
            "true"
        );
        ...
        summaryEyebrow.className =
            "msa-release-briefing__eyebrow";
        ...
        summaryTitle.textContent =
            `${currentRelease.changes.length} portfolio improvements`;
        ...
        controls.className =
            "msa-release-briefing__controls";
        ...
        closeButton.className =
            "msa-release-briefing__close";


        closeButton.setAttribute(
            "aria-label",
            "Dismiss website update briefing"
        );
        ...
        releaseDate.className =
            "msa-release-briefing__date";


        releaseDate.textContent =
            `Latest release · ${currentRelease.date}`;
        ...
        currentRelease.changes.forEach(
            change => {
        ...
        function dismissBriefing(){
            ...
            rememberCurrentRelease();


            briefing.classList.add(
                "is-leaving"
            );
    ...
    /* ======================================================
       WAIT FOR THE CINEMATIC WELCOME
    ====================================================== */
